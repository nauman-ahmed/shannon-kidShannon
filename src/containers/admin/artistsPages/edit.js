...
function Edit(props) {
    ...
    useEffect(() => {
        ...
        setType(String(props.selectedArtist.type));
    }, [])
    return (
        <div className='row px-5 mx-5'>
            ...
            <label className='col-12 mt-3'>Kid Shanon</label>
            <label className='px-3'>
                <input className='mr-2' name="type" type="radio" value={"kidshannon"}  checked={type === "kidshannon"} onChange={(e)=>{setType(e.target.value);}}/>
                {"Yes"}
            </label>
            <label className='px-3'>
                <input className='mr-2' name="type" type="radio" value={"shannon"} checked={type === "shannon"}  onChange={(e)=>{setType(e.target.value);}}/>
                {"No"}
            </label>
