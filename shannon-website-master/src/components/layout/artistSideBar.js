        ...
        <div key={key}>
          ...
          <div key={key}>
            ...
            {artistData[item].map((item1,key1)=>(
              <div key={key1}>
               <Link to={props.kid?"/kidshanon/artists/"+item1.firstname:"/artists/"+item1.firstname} className="sidebarlink">{item1.firstname.toUpperCase()} {item1.lastname.toUpperCase()}<br/></Link>
              </div>
            ))}
            <br/>
          </div>
